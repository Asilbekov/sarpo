...
// All photos are extracted from the SARPO SVG design mockups
// Studio cutouts on black background — Uzbek traditional women's clothing
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 42.00,
    image: '/images/product_white_gold.jpg',
    category: "Women's Tops",
    collection: 'Осенняя коллекция',
    isNew: true,
  ...
  },
  {
    ...
    price: 28.50,
    image: '/images/product_black_embroidered.jpg',
    category: "Women's Tops",
  ...
  },
  {
    ...
    price: 55.00,
    image: '/images/product_mint_gold.jpg',
    category: "Women's Tops",
  ...
  },
  {
    ...
    price: 30.00,
    image: '/images/product_green.jpg',
    category: "Women's Tops",
    collection: 'Летняя коллекция',
    isNew: true,
  ...
  },
  {
    ...
    price: 24.99,
    image: '/images/product_burgundy_sheer.jpg',
    category: "Women's Tops",
    collection: 'Летняя коллекция',
  ...
  },
  {
    ...
    price: 29.99,
    image: '/images/product_white_cape.jpg',
    category: "Women's Tops",
    collection: 'Весенняя коллекция',
  ...
  },
  {
    ...
    price: 65.00,
    image: '/images/product_beige_embroidered.jpg',
    category: "Women's Tops",
  ...
  },
  {
    ...
    price: 49.00,
    image: '/images/product_burgundy_dress.jpg',
    category: "Women's Tops",
    collection: 'Осенняя коллекция',
...
// Thumbnail variants for product page gallery
export const productGallery = [
  '/images/product_blue_grey.jpg',
  '/images/product_white_gold.jpg',
  '/images/product_mint_gold.jpg',
